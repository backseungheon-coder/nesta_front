    ...
    return(
        <Container_styled>
            <Inner_top_Box>
                <Grid_Box >
                    <Inner_circle>
                    <div style={{fontWeight:'bold',fontSize:'30px',color:'#ffffff'}}>{row.store}</div>
                    </Inner_circle>
                    <div style={{marginTop:'10px',fontSize:'20px',fontWeight:'bold',color:'black'}}>그룹 가맹점 수</div>
                </Grid_Box>
                <Grid_Box >
                <Inner_circle style={{backgroundImage:'linear-gradient(135deg, #0d99ff 40%, #466FFF 100%)'}}>
                <div style={{fontWeight:'bold',fontSize:'30px',color:'#ffffff'}}>{row.agency}</div>
                    </Inner_circle>
                    <div style={{marginTop:'10px',fontSize:'20px',fontWeight:'bold',color:'black'}}>그룹 대리점 수</div>
                </Grid_Box>

                <Top_Box_con>
                    <Top_Box_inner>
                        <Inner_circle_small>
                        <div style={{fontWeight:'bold',fontSize:'30px',color:'#ffffff'}}>{row.d_agency}</div>
                        </Inner_circle_small>
                        <div style={{display:'flex', flexDirection:'column',alignItems: 'center'}}>
                            <div style={{fontSize:'20px',color:'black',fontWeight:'bold',marginTop:'10px'}}>
                                    오늘 실적 수
                            </div>
                        </div>
                    </Top_Box_inner>
                    <Top_Box_inner >
                        <Inner_circle_small style={{backgroundImage:'linear-gradient(135deg, #0d99ff 40%, #466FFF 100%)'}}>
                        <div style={{fontWeight:'bold',fontSize:'30px',color:'#ffffff'}}>{row.m_agency}</div>
                        </Inner_circle_small>
                        <div style={{display:'flex', flexDirection:'column',alignItems: 'center'}}>
                        <div style={{fontSize:'20px',color:'black',fontWeight:'bold',marginTop:'10px'}}>
                                    이번달 실적 수
